...
export default function CartSummary({ onOpenCart, currencySymbol }: Props) {
  ...
  return (
    <button
      type="button"
      className="inline-flex items-center gap-2 whitespace-nowrap rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 shadow-sm hover:bg-slate-50"
      onClick={onOpenCart}
    >
